"use strict";
app.controller("benfeitoriasController", function($scope, $location, Propriedade){

	$scope.table_name = "benfeitorias";
	...
	$scope.save = function(){
		...
		$scope.form = {};
		$scope.list();
		$('#benfeitoriasController').modal('hide');
	}
	...
	$scope.edit = function(data){
		$scope.form = data;
		$('#benfeitoriasController').modal('show');
	}
